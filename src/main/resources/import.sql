...
INSERT INTO "public"."swtvap_orders" (id,client_id,code,other_date,status,address,subtotal,taxes,discount_amount,total,pick_up) VALUES (2,2,'ORDER-00000002','06-01-2023 17:00:54',1,'Av. los cedros 1123 , SPM',100.39,10.2,5.10,110.80,true);
INSERT INTO "public"."swtvap_orders" (id,client_id,code,other_date,status,address,subtotal,taxes,discount_amount,total,pick_up) VALUES (3,3,'ORDER-00000003','06-01-2023 17:00:54',1,'Av. los pinares 3321, SJL',100.39,10.2,5.10,110.80,false);
